...
const CreateEmployee = ({ id, handleClose }: { id: any; handleClose?: () => void }) => {
  ...
  return (
    <>
      <div className='p-1'>
        <div className='flex justify-center max-md:h-[90svh] max-md:overflow-y-auto bg-backgroundPaper md:is-[600px]'>
