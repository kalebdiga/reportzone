...
const CreateEmployee = ({ handleClose }: { handleClose?: () => void }) => {
  ...
  return (
    <>
      <div className='p-14'>
        <div className=' border rounded border-textPrimary p-4 bg-backgroundPaper'>
          {!handleClose && (
            <div className='w-[100%] bg-backgroundPaper text-textPrimary  '>
              <div className='w-[100%] flex items-center justify-start pt-[2%] px-[2%]  gap-[12px]'>
                <Link href={'/employees'}>
